...
const GET_COUNTRY_DAILY_INFO = {
    ...
    async resolve(parent, args) {
        ...
        values.map(date => {
            ...
            response.new_confirmed.push(currentCountry.today_new_confirmed);
            response.new_recovered.push(currentCountry.today_new_recovered);
            response.new_deaths.push(currentCountry.today_new_deaths);
        })
